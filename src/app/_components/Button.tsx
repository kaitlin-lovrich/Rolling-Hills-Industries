...
export function Button({ handleClick, text }: ButtonProps) {
    return (
        <button
            onClick={handleClick}
            className="flex bg-navy-blue/85 hover:bg-navy-blue/75 rounded-full drop-shadow-md text-white hover:text-yellow items-center group duration-300 ease-out"
        >
            {text}
