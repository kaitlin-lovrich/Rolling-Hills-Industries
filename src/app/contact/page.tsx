      ...
      >
          ...
          <div className="flex flex-col sm:flex-row justify-around items-start gap-5 sm:gap-9 lg:gap-14 xl:gap-16 lg:px-0 w-full *:leading-relaxed text-start">
            <div className="flex flex-col gap-3 sm:gap-5 px-4 sm:px-2 lg:px-0">
              ...
              <address className="flex flex-col gap-3 xl:gap-5 not-italic px-2 lg:px-0">
                ...
                <p>
                  <a href="tel:724-539-4199" className="hover:underline">
                    724-539-4199
                  </a>
                </p>
              </address>
        ...
        <article className="flex flex-col justify-center items-center gap-5 lg:gap-7 xl:gap-10 w-full px-2 lg:px-0 md:w-[90%] xl:w-[95%] mx-auto *:leading-relaxed">
          ...
          <div className="flex flex-col gap-5">
            <p>
              Are you interested in our services? We welcome the opportunity to
              talk with you about your cleaning needs and provide you with a
              free estimate. We are confident the quality of our services will
              provide you a clean environment where employees feel healthy,
              productivity is high, and customers are satisfied.
            </p>
          </div>
        </article>
      </section>
      <section className="mx-auto w-[95%] max-w-[1400px]">
        <article className="relative mt-2 drop-shadow-lg">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-5 xl:gap-7">
              ...
              <label htmlFor="services_needed">
                ...
                >
                  ...
                  <option value="general-janitorial">General Janitorial</option>
                  ...
                  <option value="specialty-service">Specialty Service</option>
                  <option value="other">Other</option>
                </select>
              </label>
            </div>
            ...
            <div className="text-lg md:text-2xl 2xl:text-3xl *:gap-0.5 *:md:gap-4 *:pl-5 *:md:pl-10 *:py-1 *:md:py-1.5 *:2xl:py-2 *:*:*:size-8 *:*:*:lg:size-9 *:*:*:2xl:size-11 *:*:pr-1.5 *:*:md:pr-4">
